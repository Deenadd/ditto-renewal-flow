...
import { ArrowLeftIcon, ChevronDownIcon, MailIcon, PhoneIcon } from "@/components/icons";
...
/** Collapsed policy bar tucked under the nav (node 121:7482). */
function PolicyBar() {
  return (
    <div className="flex items-center gap-4 rounded-b-xl border-r border-b border-l border-[#e8eaeb] bg-white px-4 py-3 shadow-card">
      ...
      <div className="flex min-w-0 flex-1 flex-col gap-1.5">
        ...
        <p className="ff-figures text-[12px] leading-none tracking-[0.06px] text-ink-secondary">
          Cover: {policy.cover.replace("Lakhs", "L")}{" "}
          <span className="text-grey-200">•</span> Premium: {policy.premium} /{" "}
